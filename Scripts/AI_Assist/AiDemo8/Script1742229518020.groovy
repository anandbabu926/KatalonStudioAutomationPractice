 ...
 *  5. Search  a Blue T-shirt and add it to the shopping cart.
...
// Search for a Blue T-shirt and add it to the shopping cart
WebUI.setText(findTestObject('Page_Home/input_Search'), 'Blue T-shirt')
