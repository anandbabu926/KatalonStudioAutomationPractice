 ...
 * 2. Click the Login
 * 3. Fill in the valid username and invalid password fields based on the variables
...
WebUI.setText(findTestObject('Page_Login/input_Password'), invalidPassword) // invalidPassword is a variable

// Click the login button
WebUI.click(findTestObject('Page_Login/button_Submit'))

// Verify that the Dashboard exists
WebUI.verifyElementPresent(findTestObject('Page_Dashboard/element_Dashboard'), 10)
