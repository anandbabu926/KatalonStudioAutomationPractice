...
WebUI.setText(findTestObject('Page_Login/input_Username'), username) // username is a predefined variable
WebUI.setText(findTestObject('Page_Login/input_Password'), password) // password is a predefined variable
