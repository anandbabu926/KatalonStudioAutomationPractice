...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Shop/input_Email address_email'), GlobalVariable.USERNAME)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login - My Shop/input_Password_passwd'), GlobalVariable.PASSWORD)
