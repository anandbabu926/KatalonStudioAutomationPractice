...
WebUI.click(findTestObject('Object Repository/Page_Login - My Shop/label_Email address'))

WebUI.setText(findTestObject('Object Repository/Page_Login - My Shop/input_Email address_email'), username)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login - My Shop/input_Password_passwd'), password)
